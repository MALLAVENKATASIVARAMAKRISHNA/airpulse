...
export default function AuthorityDashboard({ profile, onSignOut, theme, toggleTheme }) {
  ...
  const [alertingNode, setAlertingNode] = useState(null)
  const lastAlertedTimes = useRef({})
  ...
  useEffect(() => {
    ...
    if (dangerousNode) {
      lastAlertedTimes.current[dangerousNode.node_id] = dangerousNode.recorded_at
      setAlertingNode(dangerousNode)
